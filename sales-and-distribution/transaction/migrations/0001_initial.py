# Generated by Django 2.2 on 2019-07-05 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.CharField(max_length=100)),
                ('meas', models.CharField(max_length=100)),
                ('header_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='transaction.JobOrderHeader')),
                ('item_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='inventory.Add_item')),
            ],
        ),
    ]
