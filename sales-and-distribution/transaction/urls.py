...
urlpatterns = [
    ...
    path('sale_return/edit/<pk>', views.edit_sale_return, name='edit-sale-return'),
    ...
    path('all_receivable_ledger/pdf/<pk>', views.all_receivable_ledger, name='all-receivable-ledger'),
